...
# !gdown --id '1vH_PLFrkK0IeJtrSeyITLVZLgpFLWisc' --output Dataset.zip
!wget http://140.112.30.39:12345/Dataset.zip
...
class TransformerEncoderLayer(nn.Module):
    ...
    def __init__(self, d_model, nhead, dim_feedforward, dropout=0.1, activation="relu"):
        ...
        self.Conv1d1 = Conv1d(in_channels = d_model, out_channels = 512, kernel_size=1)
        self.dropout = Dropout(dropout)
        self.Conv1d2 = Conv1d(in_channels = 512, out_channels = d_model, kernel_size=1)
    ...
    def forward(self, src: Tensor, src_mask: Optional[Tensor] = None, src_key_padding_mask: Optional[Tensor] = None) -> Tensor:
        ...
        src = self.norm1(src)
        #  src: ( batch_size,d_model,length)
        src = src.permute(1, 2, 0)
        src2 = self.dropout(self.activation(self.Conv1d1(src)))
        src2 = self.Conv1d2(src2)
